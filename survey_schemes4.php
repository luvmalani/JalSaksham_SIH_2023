...
<body style="background-color: #fff9d2;  ">
  ...
  <div class="survey-container">
    ...
    <button type="submit"  style="margin-left:340px ;background-color: rgb(44, 219, 44);" onclick="location.href='https://hortnet.gov.in/NHMhome_new.aspx';" class="btn">Submit</button>
